...
```{r fitmod, cache = TRUE, results = 'hide'}
set.seed(19084)
...
```{r fitmod-rf, cache = TRUE, results = 'hide', warning = FALSE}
set.seed(843592734)
...
```{r fitwbart, results = 'hide', cache = TRUE}
set.seed(398043)
...
```{r fitstratbart, results = 'hide', cache = TRUE}
set.seed(398043)
